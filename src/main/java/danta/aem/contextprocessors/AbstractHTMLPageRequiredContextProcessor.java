...
/**
 * The abstraction for HTML Page Required Context Processor
 *
 * @author      joshuaoransky
 * @version     1.0.0
 * @since       2013-11-08
 */
public abstract class AbstractHTMLPageRequiredContextProcessor<C extends ContentModel>
        extends AbstractCheckComponentCategoryContextProcessor<C> {

    @Override
    public Set<String> allOf() {
        return Sets.newHashSet(PAGE_CATEGORY, HTML_PAGE_CATEGORY);
    }
