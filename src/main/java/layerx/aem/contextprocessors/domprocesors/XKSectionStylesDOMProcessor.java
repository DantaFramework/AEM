...
package layerx.aem.contextprocessors.domprocesors;

import layerx.aem.contextprocessors.AddStylingContextProcessor;
...
import static layerx.Constants.HIGHEST_PRIORITY;
...
public class XKSectionStylesDOMProcessor
    ...
    /**
     * Returns the DOMProcessor priority, which is HIGHEST_PRIORITY (See {@link layerx.Constants}).
     * @return  HIGHEST_PRIORITY (See {@link layerx.Constants}).
     */
    @Override
    public int priority() {
